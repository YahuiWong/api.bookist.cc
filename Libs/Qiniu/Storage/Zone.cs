...
namespace Qiniu.Storage
{
    ...
    public class Zone
    {
        ...
        public static Zone Create(ZoneType type)
        {
            switch (type)
            {
                case ZoneType.ZONE_CN_East:
                    return new Zone
                    {
                        RsHost = "rs.qiniu.com",
                        ...
                        SrcUpHosts = new string[] { "up.qiniup.com", "up-nb.qiniup.com", "up-xs.qiniup.com" },
                        CdnUpHosts = new string[] { "upload.qiniup.com", "upload-nb.qiniup.com", "upload-xs.qiniup.com" }
                    };
                case ZoneType.ZONE_CN_North:
                    return new Zone
                    {
                ...
                case ZoneType.ZONE_CN_South:
                    return new Zone
                    {
                        ...
                        SrcUpHosts = new string[] { "up-z2.qiniup.com", "up-gz.qiniup.com", "up-fs.qiniup.com" },
                        CdnUpHosts = new string[] { "upload-z2.qiniup.com", "upload-gz.qiniup.com", "upload-fs.qiniup.com" }
                    };
                case ZoneType.ZONE_US_North:
                    return new Zone
                    {
